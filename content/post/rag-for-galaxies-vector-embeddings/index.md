...
How many dimensions should your embeddings have? It depends on what you're optimizing for.

| Dimension | Storage (6.4M records) | Query Speed | Similarity Quality |
|-----------|------------------------|-------------|-------------------|
| 128 | ~3.2 GB | ~5ms | Broad groupings - "roughly similar" |
| 512 | ~13 GB | ~15ms | Captures subtle differences |
| 1024 | ~26 GB | ~30ms | Discriminates rare edge cases |
